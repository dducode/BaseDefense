    ...
    var W = H((M, q) => {
        (function () {
            ...
            t.utils = {}, t.utils.warn = function (e) {
                ...
                if (e == null) return e;
                for (var r = Object.create(null), i = Object.keys(e), n = 0; n < i.length; n++) {
                    var s = i[n], o = e[s];
                    if (Array.isArray(o)) {
                        r[s] = o.slice();
                        continue
                ...
                var i = e.slice(0, r), n = e.slice(r + 1);
            ...
            t.Set = function (e) {
                ...
                this.length < e.length ? (r = this, i = e) : (r = e, i = this), n = Object.keys(r.elements);
            ...
            t.tokenizer = function (e, r) {
                ...
                if (Array.isArray(e)) return e.map(function (v) {
                    return new t.Token(t.utils.asString(v).toLowerCase(), t.utils.clone(r))
                });
                for (var i = e.toString().toLowerCase(), n = i.length, s = [], o = 0, u = 0; o <= n; o++) {
                    var l = i.charAt(o), a = o - u;
                    if (l.match(t.tokenizer.separator) || o == n) {
                        if (a > 0) {
                            var d = t.utils.clone(r) || {};
                            d.position = [u, a], d.index = s.length, s.push(new t.Token(i.slice(u, o), d))
                        }
                        u = o + 1
                    }
                }
...
`, e)
                ...
                return e.forEach(function (i) {
                    ...
                    if (n) r.add(n); else throw new Error("Cannot load unregistered function: " + i)
                }), r
                ...
                for (var r = this._stack.length, i = 0; i < r; i++) {
                    for (var n = this._stack[i], s = [], o = 0; o < e.length; o++) {
                        var u = n(e[o], o, e);
                        if (!(u == null || u === "")) if (Array.isArray(u)) for (var l = 0; l < u.length; l++) s.push(u[l]); else s.push(u)
                    }
                    e = s
                }
                return e
            ...
            t.Vector = function (e) {
                ...
                for (var r = 0, i = this.elements.length / 2, n = i - r, s = Math.floor(n / 2), o = this.elements[s * 2]; n > 1 && (o < e && (r = s), o > e && (i = s), o != e);) n = i - r, s = r + Math.floor(n / 2), o = this.elements[s * 2];
                ...
                this.elements[n] == e ? this.elements[n + 1] = i(this.elements[n + 1], r) : this.elements.splice(n, 0, e, r)
                ...
                for (var r = 0, i = this.elements, n = e.elements, s = i.length, o = n.length, u = 0, l = 0, a = 0, d = 0; a < s && d < o;) u = i[a], l = n[d], u < l ? a += 2 : u > l ? d += 2 : u == l && (r += i[a + 1] * n[d + 1], a += 2, d += 2);
                return r
            }, t.Vector.prototype.similarity = function (e) {
                return this.dot(e) / this.magnitude() || 0
            }, t.Vector.prototype.toArray = function () {
                for (var e = new Array(this.elements.length / 2), r = 1, i = 0; r < this.elements.length; r += 2, i++) e[i] = this.elements[r];
                return e
            ...
            t.stemmer = function () {
                var e = {
                    ...
                    i = "[^aeiou]", n = "[aeiouy]", s = i + "[^aeiouy]*", o = n + "[aeiou]*",
                    u = "^(" + s + ")?" + o + s, l = "^(" + s + ")?" + o + s + "(" + o + ")?$",
                    a = "^(" + s + ")?" + o + s + o + s, d = "^(" + s + ")?" + n, v = new RegExp(u), p = new RegExp(a),
                    S = new RegExp(l), x = new RegExp(d), L = /^(.+?)(ss|i)es$/, f = /^(.+?)([^s])s$/, y = /^(.+?)eed$/,
                    w = /^(.+?)(ed|ing)$/, b = /.$/, k = /(at|bl|iz)$/, I = new RegExp("([^aeiouylsz])\\1$"),
                    A = new RegExp("^" + s + n + "[^aeiouwxy]$"), F = /^(.+?[^aeiou])y$/,
                    ...
                    N = /^(.+?)(s|t)(ion)$/, E = /^(.+?)e$/, B = /ll$/, z = new RegExp("^" + s + n + "[^aeiouwxy]$"),
                    D = function (h) {
                        var g, T, P, c, m, O, R;
                        if (h.length < 3) return h;
                        if (P = h.substr(0, 1), P == "y" && (h = P.toUpperCase() + h.substr(1)), c = L, m = f, c.test(h) ? h = h.replace(c, "$1$2") : m.test(h) && (h = h.replace(m, "$1$2")), c = y, m = w, c.test(h)) {
                            var Q = c.exec(h);
                            c = v, c.test(Q[1]) && (c = b, h = h.replace(c, ""))
                        } else if (m.test(h)) {
                            var Q = m.exec(h);
                            g = Q[1], m = x, m.test(g) && (h = g, m = k, O = I, R = A, m.test(h) ? h = h + "e" : O.test(h) ? (c = b, h = h.replace(c, "")) : R.test(h) && (h = h + "e"))
                        }
                        if (c = F, c.test(h)) {
                            var Q = c.exec(h);
                            g = Q[1], h = g + "i"
                        ...
                        if (c = E, c.test(h)) {
                            var Q = c.exec(h);
                            g = Q[1], c = p, m = S, O = z, (c.test(g) || m.test(g) && !O.test(g)) && (h = g)
                        }
                        return c = B, m = p, c.test(h) && m.test(h) && (c = b, h = h.replace(c, "")), P == "y" && (h = P.toLowerCase() + h.substr(1)), h
                    };
                return function (_) {
                    return _.update(D)
                }
            ...
            t.TokenSet = function () {
                ...
                for (var r = new t.TokenSet.Builder, i = 0, n = e.length; i < n; i++) r.insert(e[i]);
                ...
                for (var i = new t.TokenSet, n = [{node: i, editsRemaining: r, str: e}]; n.length;) {
                    var s = n.pop();
                    if (s.str.length > 0) {
                        var o = s.str.charAt(0), u;
                        o in s.node.edges ? u = s.node.edges[o] : (u = new t.TokenSet, s.node.edges[o] = u), s.str.length == 1 && (u.final = !0), n.push({
                            node: u,
                    ...
                    if (s.editsRemaining != 0) {
                        ...
                        if (s.str.length == 0 && (l.final = !0), n.push({
                            node: l,
                            ...
                            if ("*" in s.node.edges) var a = s.node.edges["*"]; else {
                                var a = new t.TokenSet;
                                s.node.edges["*"] = a
                            }
                            s.str.length == 1 && (a.final = !0), n.push({
                                node: a,
                                editsRemaining: s.editsRemaining - 1,
                                str: s.str.slice(1)
                            })
                        ...
                        if (s.str.length > 1) {
                            var d = s.str.charAt(0), v = s.str.charAt(1), p;
                            v in s.node.edges ? p = s.node.edges[v] : (p = new t.TokenSet, s.node.edges[v] = p), s.str.length == 1 && (p.final = !0), n.push({
                                node: p,
                                editsRemaining: s.editsRemaining - 1,
                                str: d + s.str.slice(2)
                            })
                ...
                for (var r = new t.TokenSet, i = r, n = 0, s = e.length; n < s; n++) {
                    var o = e[n], u = n == s - 1;
                    if (o == "*") r.edges[o] = r, r.final = u; else {
                        var l = new t.TokenSet;
                ...
                for (var e = [], r = [{prefix: "", node: this}]; r.length;) {
                    var i = r.pop(), n = Object.keys(i.node.edges), s = n.length;
                ...
                for (var e = this.final ? "1" : "0", r = Object.keys(this.edges).sort(), i = r.length, n = 0; n < i; n++) {
                    var s = r[n], o = this.edges[s];
                    e = e + s + o.id
                }
                return e
            }, t.TokenSet.prototype.intersect = function (e) {
                for (var r = new t.TokenSet, i = void 0, n = [{qNode: e, output: r, node: this}]; n.length;) {
                    i = n.pop();
                    for (var s = Object.keys(i.qNode.edges), o = s.length, u = Object.keys(i.node.edges), l = u.length, a = 0; a < o; a++) for (var d = s[a], v = 0; v < l; v++) {
                        var p = u[v];
                        if (p == d || d == "*") {
                            var S = i.node.edges[p], x = i.qNode.edges[d], L = S.final && x.final, f = void 0;
                            p in i.output.edges ? (f = i.output.edges[p], f.final = f.final || L) : (f = new t.TokenSet, f.final = L, i.output.edges[p] = f), n.push({
                                qNode: x,
                                output: f,
                                node: S
                            })
                ...
                for (var n = 0; n < e.length && n < this.previousWord.length && e[n] == this.previousWord[n]; n++) i++;
                this.minimize(i), this.uncheckedNodes.length == 0 ? r = this.root : r = this.uncheckedNodes[this.uncheckedNodes.length - 1].child;
                for (var n = i; n < e.length; n++) {
                    var s = new t.TokenSet, o = e[n];
                ...
                for (var r = this.uncheckedNodes.length - 1; r >= e; r--) {
                    var i = this.uncheckedNodes[r], n = i.child.toString();
            ...
            t.Index = function (e) {
                ...
                for (var r = new t.Query(this.fields), i = Object.create(null), n = Object.create(null), s = Object.create(null), o = Object.create(null), u = Object.create(null), l = 0; l < this.fields.length; l++) n[this.fields[l]] = new t.Vector;
                e.call(r, r);
                for (var l = 0; l < r.clauses.length; l++) {
                    var a = r.clauses[l], d = null, v = t.Set.empty;
                    a.usePipeline ? d = this.pipeline.runString(a.term, {fields: a.fields}) : d = [a.term];
                    for (var p = 0; p < d.length; p++) {
                        var S = d[p];
                        a.term = S;
                        var x = t.TokenSet.fromClause(a), L = this.tokenSet.intersect(x).toArray();
                        ...
                        for (var w = 0; w < L.length; w++) for (var b = L[w], k = this.invertedIndex[b], I = k._index, f = 0; f < a.fields.length; f++) {
                            var y = a.fields[f], A = k[y], F = Object.keys(A), V = b + "/" + y, j = new t.Set(F);
                            if (a.presence == t.Query.presence.REQUIRED && (v = v.union(j), o[y] === void 0 && (o[y] = t.Set.complete)), a.presence == t.Query.presence.PROHIBITED) {
                                u[y] === void 0 && (u[y] = t.Set.empty), u[y] = u[y].union(j);
                                continue
                            }
                            if (n[y].upsert(I, a.boost, function (J, G) {
                                return J + G
                            }), !s[V]) {
                                for (var C = 0; C < F.length; C++) {
                                    var N = F[C], E = new t.FieldRef(N, y), B = A[N], z;
                                    (z = i[E]) === void 0 ? i[E] = new t.MatchData(b, y, B) : z.add(b, y, B)
                                }
                                s[V] = !0
                            }
                        }
                    }
                    if (a.presence === t.Query.presence.REQUIRED) for (var f = 0; f < a.fields.length; f++) {
                        var y = a.fields[f];
                        o[y] = o[y].intersect(v)
                    }
                }
                for (var D = t.Set.complete, _ = t.Set.empty, l = 0; l < this.fields.length; l++) {
                    var y = this.fields[l];
                    o[y] && (D = D.intersect(o[y])), u[y] && (_ = _.union(u[y]))
                }
                var h = Object.keys(i), g = [], T = Object.create(null);
                if (r.isNegated()) {
                    h = Object.keys(this.fieldVectors);
                    for (var l = 0; l < h.length; l++) {
                        var E = h[l], P = t.FieldRef.fromString(E);
                        i[E] = new t.MatchData
                    }
                }
                for (var l = 0; l < h.length; l++) {
                    var P = t.FieldRef.fromString(h[l]), c = P.docRef;
                    if (D.contains(c) && !_.contains(c)) {
                        var m = this.fieldVectors[P], O = n[P.fieldName].similarity(m), R;
                        if ((R = T[c]) !== void 0) R.score += O, R.matchData.combine(i[P]); else {
                ...
                }, this), r = Object.keys(this.fieldVectors).map(function (i) {
                ...
                var r = {}, i = {}, n = e.fieldVectors, s = Object.create(null), o = e.invertedIndex,
                    u = new t.TokenSet.Builder, l = t.Pipeline.load(e.pipeline);
                ...
                for (var a = 0; a < n.length; a++) {
                    var d = n[a], v = d[0], p = d[1];
                    i[v] = new t.Vector(p)
                }
                for (var a = 0; a < o.length; a++) {
                    var d = o[a], S = d[0], x = d[1];
                    u.insert(S), s[S] = x
                }
                return u.finish(), r.fields = e.fields, r.fieldVectors = i, r.invertedIndex = s, r.tokenSet = u.root, r.pipeline = l, new t.Index(r)
            };
            t.Builder = function () {
                ...
                var i = e[this._ref], n = Object.keys(this._fields);
                this._documents[i] = r || {}, this.documentCount += 1;
                for (var s = 0; s < n.length; s++) {
                    var o = n[s], u = this._fields[o].extractor, l = u ? u(e) : e[o],
                        a = this.tokenizer(l, {fields: [o]}), d = this.pipeline.run(a), v = new t.FieldRef(i, o),
                        p = Object.create(null);
                    this.fieldTermFrequencies[v] = p, this.fieldLengths[v] = 0, this.fieldLengths[v] += d.length;
                    for (var S = 0; S < d.length; S++) {
                        var x = d[S];
                        if (p[x] == null && (p[x] = 0), p[x] += 1, this.invertedIndex[x] == null) {
                            var L = Object.create(null);
                            L._index = this.termIndex, this.termIndex += 1;
                            for (var f = 0; f < n.length; f++) L[n[f]] = Object.create(null);
                            this.invertedIndex[x] = L
                        }
                        this.invertedIndex[x][o][i] == null && (this.invertedIndex[x][o][i] = Object.create(null));
                        for (var y = 0; y < this.metadataWhitelist.length; y++) {
                            var w = this.metadataWhitelist[y], b = x.metadata[w];
                            this.invertedIndex[x][o][i][w] == null && (this.invertedIndex[x][o][i][w] = []), this.invertedIndex[x][o][i][w].push(b)
                        }
                    }
                }
            }, t.Builder.prototype.calculateAverageFieldLengths = function () {
                for (var e = Object.keys(this.fieldLengths), r = e.length, i = {}, n = {}, s = 0; s < r; s++) {
                    var o = t.FieldRef.fromString(e[s]), u = o.fieldName;
                    n[u] || (n[u] = 0), n[u] += 1, i[u] || (i[u] = 0), i[u] += this.fieldLengths[o]
                }
                ...
                for (var e = {}, r = Object.keys(this.fieldTermFrequencies), i = r.length, n = Object.create(null), s = 0; s < i; s++) {
                    for (var o = t.FieldRef.fromString(r[s]), u = o.fieldName, l = this.fieldLengths[o], a = new t.Vector, d = this.fieldTermFrequencies[o], v = Object.keys(d), p = v.length, S = this._fields[u].boost || 1, x = this._documents[o.docRef].boost || 1, L = 0; L < p; L++) {
                        var f = v[L], y = d[f], w = this.invertedIndex[f]._index, b, k, I;
                        n[f] === void 0 ? (b = t.idf(this.invertedIndex[f], this.documentCount), n[f] = b) : b = n[f], k = b * ((this._k1 + 1) * y) / (this._k1 * (1 - this._b + this._b * (l / this.averageFieldLength[u])) + y), k *= S, k *= x, I = Math.round(k * 1e3) / 1e3, a.insert(w, I)
                    }
                    e[o] = a
                }
                this.fieldVectors = e
                ...
                for (var n = Object.create(null), s = Object.keys(i || {}), o = 0; o < s.length; o++) {
                    var u = s[o];
                    n[u] = i[u].slice()
                }
                this.metadata = Object.create(null), e !== void 0 && (this.metadata[e] = Object.create(null), this.metadata[e][r] = n)
            }, t.MatchData.prototype.combine = function (e) {
                for (var r = Object.keys(e.metadata), i = 0; i < r.length; i++) {
                    var n = r[i], s = Object.keys(e.metadata[n]);
                    this.metadata[n] == null && (this.metadata[n] = Object.create(null));
                    for (var o = 0; o < s.length; o++) {
                        var u = s[o], l = Object.keys(e.metadata[n][u]);
                        this.metadata[n][u] == null && (this.metadata[n][u] = Object.create(null));
                        for (var a = 0; a < l.length; a++) {
                            var d = l[a];
                            this.metadata[n][u][d] == null ? this.metadata[n][u][d] = e.metadata[n][u][d] : this.metadata[n][u][d] = this.metadata[n][u][d].concat(e.metadata[n][u][d])
                        }
                    }
                }
                ...
                for (var n = Object.keys(i), s = 0; s < n.length; s++) {
                    var o = n[s];
                    o in this.metadata[e][r] ? this.metadata[e][r][o] = this.metadata[e][r][o].concat(i[o]) : this.metadata[e][r][o] = i[o]
                }
            }, t.Query = function (e) {
                ...
                if (Array.isArray(e)) return e.forEach(function (n) {
                    this.term(n, t.utils.clone(r))
                }, this), this;
                var i = r || {};
                return i.term = e.toString(), this.clause(i), this
            }, t.QueryParseError = function (e, r, i) {
                this.name = "QueryParseError", this.message = e, this.start = r, this.end = i
                ...
                for (var e = [], r = this.start, i = this.pos, n = 0; n < this.escapeCharPositions.length; n++) i = this.escapeCharPositions[n], e.push(this.str.slice(r, i)), r = i + 1;
                ...
                if (r != null) switch (r.type) {
                    ...
                    default:
                        ...
                        throw r.str.length >= 1 && (i += " with value '" + r.str + "'"), new t.QueryParseError(i, r.start, r.end)
                }
                ...
                typeof define == "function" && define.amd ? define(r) : typeof M == "object" ? q.exports = r() : e.lunr = r()
            }(this, function () {
                return t
            })
        })()
    ...
    (function () {
        ...
        n.open("GET", "../search-stopwords.json"), n.onload = function () {
            this.status == 200 && (r = JSON.parse(this.responseText), o())
        }, n.send();
        var s = new XMLHttpRequest;
        s.open("GET", "../index.json"), s.onload = function () {
            this.status == 200 && (i = JSON.parse(this.responseText), o(), postMessage({e: "index-ready"}))
        }, s.send(), onmessage = function (l) {
            var a = l.data.q, d = e.search(a), v = [];
        ...
        function o() {
            r !== null && !u(i) && (e = t(function () {
                this.pipeline.remove(t.stopWordFilter), this.ref("href"), this.field("title", {boost: 50}), this.field("keywords", {boost: 20});
                for (var l in i) i.hasOwnProperty(l) && this.add(i[l]);
                var a = t.generateStopWordFilter(r);
                t.Pipeline.registerFunction(a, "docfxStopWordFilter"), this.pipeline.add(a), this.searchPipeline.add(a)
            }))
        }
