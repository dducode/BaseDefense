...
namespace BaseDefense {
    ...
    public static class Aes {
        ...
        private const string
            VI_KEY = "~6YUi0Sv5@|{aOZO"; // TODO: Generate random VI each encryption and store it with encrypted value


        private static string Encrypt (byte[] value, string password) {
            var keyBytes = new Rfc2898DeriveBytes(password, Encoding.UTF8.GetBytes(SALT_KEY)).GetBytes(KEY_LENGTH / 8);
